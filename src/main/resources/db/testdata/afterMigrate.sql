...
INSERT INTO restaurant (id, name, freight_rate, kitchen_id, status, address_city_id, address_zip_code, address_public_place, address_number, address_district, address_complement, registration_date, update_date) VALUES (1, 'Outback', 14.50, 1, true, 2, '38400-888', 'Rua João Pinheiro', '1000', 'Centro', '3° Andar', utc_timestamp, utc_timestamp);
INSERT INTO restaurant (id, name, freight_rate, kitchen_id, status, address_city_id, address_zip_code, address_public_place, address_number, address_district, address_complement, registration_date, update_date) VALUES (2, 'Madero', 10.25, 2, true, 1, '38400-995', 'Rua Ulisses Guimarães', '16', 'Sussuarana', 'Bloco 29', utc_timestamp, utc_timestamp);
INSERT INTO restaurant (id, name, freight_rate, kitchen_id, status, address_city_id, address_zip_code, address_public_place, address_number, address_district, address_complement, registration_date, update_date) VALUES (3, 'Java Steakhouse', 12, 3, true, 2, '38400-888', 'Rua João Pinheiro', '36', 'Centro', '5° Andar', utc_timestamp, utc_timestamp);
INSERT INTO restaurant (id, name, freight_rate, kitchen_id, status, address_city_id, address_zip_code, address_public_place, address_number, registration_date, update_date) VALUES (4, 'Lanchonete do Tio Sam', 11, 4, true, 1, '38400-3644', 'Rua dos Alfeneiros', '4', utc_timestamp, utc_timestamp);
INSERT INTO restaurant (id, name, freight_rate, kitchen_id, status, address_city_id, address_zip_code, address_public_place, address_number, address_district, address_complement, registration_date, update_date) VALUES (5, 'Bar da Maria', 6, 4, true, 2, '38400-999', 'Rua João Pinheiro', '1000', 'Centro', '2° Andar', utc_timestamp, utc_timestamp);
